...
Write-Host "  - Background image (shared with WezTerm)"
Write-Host "  - Unfocused window dimming (70% opacity)"
Write-Host "  - Per-profile tab colors (PowerShell blue, Ubuntu orange, CMD gray)"
