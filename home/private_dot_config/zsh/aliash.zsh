...
# Check chezmoi source directory first, then fallback locations
if [[ -n "${CHEZMOI_SOURCE_DIR:-}" && -f "${CHEZMOI_SOURCE_DIR}/scripts/getcontext.zsh" ]]; then
  source "${CHEZMOI_SOURCE_DIR}/scripts/getcontext.zsh"
elif [[ -f "$HOME/Code/dotfiles/scripts/getcontext.zsh" ]]; then
  source "$HOME/Code/dotfiles/scripts/getcontext.zsh"
elif [[ -f "$HOME/.local/share/chezmoi/scripts/getcontext.zsh" ]]; then
  source "$HOME/.local/share/chezmoi/scripts/getcontext.zsh"
